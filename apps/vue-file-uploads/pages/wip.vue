    ...
    <div class="w-full">
        ...
        >
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="text-lg">
                    <span class="text-blue-500 font-medium">Upload files</span> or drag and drop
                </p>
        ...
        <div class="mt-5 space-y-3">
            ...
            >
                <!-- Thumbnail -->
                <div class="w-12 h-12 flex-shrink-0 rounded-md overflow-hidden bg-gray-100 mr-3">
                    <img
                ...
                <div class="flex items-center">
                    ...
                    <span v-else class="text-sm text-red-600 bg-red-50 rounded-full px-3 py-0.5">
                        Error
                    </span>
                </div>
            </div>
