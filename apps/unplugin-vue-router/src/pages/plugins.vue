...
<template>
    ...
    <div class=" flex flex-row justify-between">
        <div>
            <span class=" w-16">Click on me
                <Tooltip :text="tooltipText"
                    :options="{ placement: 'top', hideOnClick: false, trigger: 'click', arrow: 'false' }" />
            </span>
            <span>And me
                <Tooltip :text="tooltipText" :options="{ placement: 'right', hideOnClick: false, trigger: 'click' }" />
            </span>
            <br />
        </div>
